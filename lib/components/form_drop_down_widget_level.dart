...
class FormDropDownWidgetLevel extends StatelessWidget {
  const FormDropDownWidgetLevel({
  ...
  final List<GetLevel> options;
  final GetLevel? value;
  final void Function(GetLevel) onChanged;
        ...
        builder: (FormFieldState<String> state) {
          return DropdownButtonHideUnderline(
            child: DropdownButtonFormField<String>(
              ...
              items: options.map((GetLevel value) {
